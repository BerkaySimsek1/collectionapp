...
class SmGroupAdminScreen extends StatefulWidget {
  final String groupId;
  const SmGroupAdminScreen({super.key, required this.groupId});

  @override
  SmGroupAdminScreenState createState() => SmGroupAdminScreenState();
}

class SmGroupAdminScreenState extends State<SmGroupAdminScreen> {
