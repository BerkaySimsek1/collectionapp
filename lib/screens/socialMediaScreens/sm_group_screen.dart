...
import "package:collectionapp/screens/socialMediaScreens/sm_group_admin_screen.dart";
import "package:collectionapp/designElements/widgets/create_post_widget.dart";
...
class SmGroupScreen extends StatefulWidget {
  final Group group;

  const SmGroupScreen({super.key, required this.group});

  @override
  SmGroupScreenState createState() => SmGroupScreenState();
}

class SmGroupScreenState extends State<SmGroupScreen> {
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => SmGroupAdminScreen(
                  groupId: groupId,
                ),
              ),
            );
